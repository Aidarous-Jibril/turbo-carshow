...
const Login = () => {
    ...
    return (
        ...
        //                     className={`${provider.id === 'google' ? 'bg-red-600 hover:bg-red-700 ' : 'bg-gray-600 hover:bg-gray-700 ' } outline-none py-2 md:py-2.5 border  text-white rounded-md w-full dark:bg-slate-900/80 dark:text-slate-300 dark:border-slate-700`}
